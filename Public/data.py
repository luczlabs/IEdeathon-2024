...
organization_structure = {
    ...
    "External-Public Relations": {
        ...
        "Testimonial": "KIARA MIRASOL\nASSOCIATE DIRECTOR FOR PUBLIC RELATIONS\n\nI have been working with Project Blue for over a year now, and within the year, I have gained an amazing mentor and a friend, our founder Adem Inovejas. One thing that I could say about working in the organization with him is his ability to believe in each and every one of the members’ capabilities no matter how new you are to the organization; your ideas and inputs will always be acknowledged. Stepping outside of your comfort zone is something that you will experience if you join PB because this organization does not only focus on the conservation of the environment but also the wellbeing and growth of their members. One of the many perks of joining a youth-led organization is having the opportunity to meet like-minded people who are passionate in what they do while working side by side towards the same goal."
    },
    "External-SocMed": {
